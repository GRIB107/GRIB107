...
|Telegram-bot for handmade toys sales|Writing of interactive Telegram-bot which helps and navigate customers to buy a handmade toys. Realized data storage by SQLite, API connection by Flask|**Python** **Flask** **API** **SQLite**|
